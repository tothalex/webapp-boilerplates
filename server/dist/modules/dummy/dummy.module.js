...
DummyModule = __decorate([
    common_1.Module({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: dummy_schema_1.Dummy.name, schema: dummy_schema_1.DummySchema }])],
        providers: [dummy_service_1.DummyService, auth_jwt_guard_1.JwtAuthGuard],
